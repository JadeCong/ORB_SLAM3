...
public:
   ...
   * @param filename
   */
  bool loadFromBinaryFile(const std::string &filename); // by JadeCong
   ...
   * @param filename
   */
  void saveToBinaryFile(const std::string &filename) const; // by JadeCong
...
template<class TDescriptor, class F>
bool TemplatedVocabulary<TDescriptor,F>::loadFromBinaryFile(const std::string &filename) // by JadeCong
{
    fstream f;
...
template<class TDescriptor, class F>
void TemplatedVocabulary<TDescriptor,F>::saveToBinaryFile(const std::string &filename) const // by JadeCong
{
    fstream f;
