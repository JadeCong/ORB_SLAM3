// 通过SystemSetting来读取的相机内参以及ORB特征参数(by JadeCong)
#include <iostream>
...
namespace ORB_SLAM3 {
    ...
    // SystemSetting::SystemSetting(ORBVocabulary* pVoc, KeyFrameDatabase* pKFDB):pVocabulary(pVoc), pKeyFrameDatabase(pKFDB)
    // {
